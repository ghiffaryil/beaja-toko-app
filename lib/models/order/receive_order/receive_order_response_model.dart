...
class ReceiveOrderResponseModel {
  String status;
  String message;
  Data data;

  ReceiveOrderResponseModel({
    required this.status,
    required this.message,
    required this.data,
  });

  factory ReceiveOrderResponseModel.fromJson(String str) =>
      ReceiveOrderResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ReceiveOrderResponseModel.fromMap(Map<String, dynamic> json) =>
      ReceiveOrderResponseModel(
        status: json["status"],
